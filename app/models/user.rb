class User < ApplicationRecord
  ...
  has_many :sent_requests, class_name: "Request", foreign_key: "sent_by", inverse_of: :sender, dependent: :destroy
  has_many :incoming_requests, class_name: "Request", foreign_key: "sent_to", inverse_of: :receiver, dependent: :destroy
